...
一つのチームが一日で、投稿・査読・出版・目録・読者・購読まで揃ったジャーナルサイトを立ち上げられる。
...
- 研究室や学部がセルフホストのプレプリント + ジャーナナル基盤を持ちたい
...
原稿の誕生から読者のブックマークまで、すべてのステップが一つのプラットフォームで閉じています。
