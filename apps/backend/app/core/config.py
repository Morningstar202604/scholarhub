    ...
    def validate_secrets(self) -> "Settings":
        ...
        if self.environment == "test":
            ...
            if not self.fernet_key:
                ...
                self.fernet_key = (
                    "88Q2Rl3-2UqzRfG_3tyKUPUDp9CP81YuJp2dLSkQa_0="
                )
            return self
        ...
        try:
            from cryptography.fernet import Fernet  # noqa: F401  - imported here to keep startup lean
            Fernet(self.fernet_key.encode() if isinstance(self.fernet_key, str) else self.fernet_key)
