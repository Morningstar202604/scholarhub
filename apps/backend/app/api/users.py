...
# Two-factor (TOTP) self-management moved to the M2 stack at
# ``/api/auth/2fa/*`` (app.api.two_factor) with Fernet-encrypted
# secrets. The legacy plaintext columns were migrated to the
# encrypted ones by alembic migration 019 and dropped.
