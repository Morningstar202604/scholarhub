...
def upgrade() -> None:
    # pg_trgm 是 GIN 三元组索引（标题/摘要全文搜索）的前置扩展。
    # 仅 PostgreSQL 需要；SQLite 直接跳过（无此扩展概念）。
    ...
    op.create_index(
        op.f("ix_resources_subdiscipline"), "resources", ["subdiscipline"], unique=False
    )
    op.create_index(
    ...
    op.create_index(
        ...
        "resources",
        ["tenant_id", "type", sa.literal_column("created_at DESC")],
        unique=False,
    )
    op.create_index(
    ...
    op.create_index(
        op.f("ix_author_follows_author_name"), "author_follows", ["author_name"], unique=False
    )
    op.create_index(
        op.f("ix_author_follows_tenant_id"), "author_follows", ["tenant_id"], unique=False
    )
    ...
    op.create_index(
        op.f("ix_discipline_subscriptions_discipline"),
        "discipline_subscriptions",
        ["discipline"],
        unique=False,
    )
    op.create_index(
        op.f("ix_discipline_subscriptions_tenant_id"),
        "discipline_subscriptions",
        ["tenant_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_discipline_subscriptions_user_id"),
        "discipline_subscriptions",
        ["user_id"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_doi_registrations_resource_id"), "doi_registrations", ["resource_id"], unique=False
    )
    op.create_index(
        op.f("ix_doi_registrations_tenant_id"), "doi_registrations", ["tenant_id"], unique=False
    )
    op.create_table(
        "file_assets",
        sa.Column("id", sa.Integer(), autoincrement=True, nullable=False),
    ...
    op.create_index(
        op.f("ix_file_assets_uploaded_by"), "file_assets", ["uploaded_by"], unique=False
    )
    op.create_table(
        "notifications",
        sa.Column("id", sa.Integer(), autoincrement=True, nullable=False),
    ...
    op.create_index(
        op.f("ix_reading_history_resource_id"), "reading_history", ["resource_id"], unique=False
    )
    op.create_index(
        op.f("ix_reading_history_tenant_id"), "reading_history", ["tenant_id"], unique=False
    )
    op.create_index(
        op.f("ix_reading_history_user_id"), "reading_history", ["user_id"], unique=False
    )
    op.create_index(
        op.f("ix_reading_history_viewed_at"), "reading_history", ["viewed_at"], unique=False
    )
    op.create_table(
        "reading_lists",
        sa.Column("id", sa.Integer(), autoincrement=True, nullable=False),
    ...
    op.create_index(
        op.f("ix_reading_lists_tenant_id"), "reading_lists", ["tenant_id"], unique=False
    )
    ...
    op.create_index(
        op.f("ix_subdisciplines_discipline_id"), "subdisciplines", ["discipline_id"], unique=False
    )
    op.create_index(
        op.f("ix_subdisciplines_tenant_id"), "subdisciplines", ["tenant_id"], unique=False
    )
    op.create_table(
        "submissions",
        sa.Column("id", sa.Integer(), autoincrement=True, nullable=False),
    ...
    op.create_index(
        op.f("ix_submissions_resource_id"), "submissions", ["resource_id"], unique=False
    )
    op.create_index(
        op.f("ix_submissions_reviewed_by"), "submissions", ["reviewed_by"], unique=False
    )
    ...
    op.create_index(
        op.f("ix_reading_list_items_reading_list_id"),
        "reading_list_items",
        ["reading_list_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_reading_list_items_resource_id"),
        "reading_list_items",
        ["resource_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_reading_list_items_tenant_id"), "reading_list_items", ["tenant_id"], unique=False
    )
    op.create_table(
        "review_assignments",
        sa.Column("id", sa.Integer(), autoincrement=True, nullable=False),
    ...
    op.create_index(
        op.f("ix_review_assignments_assigned_by"),
        "review_assignments",
        ["assigned_by"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_review_assignments_tenant_id"), "review_assignments", ["tenant_id"], unique=False
    )
    op.create_table(
        "submission_versions",
        sa.Column("id", sa.Integer(), autoincrement=True, nullable=False),
    ...
    op.create_index(
        op.f("ix_submission_versions_tenant_id"), "submission_versions", ["tenant_id"], unique=False
    )
    op.create_table(
        "review_reports",
        sa.Column("id", sa.Integer(), autoincrement=True, nullable=False),
    ...
    op.create_index(
        op.f("ix_review_reports_assignment_id"), "review_reports", ["assignment_id"], unique=False
    )
    op.create_index(
        op.f("ix_review_reports_tenant_id"), "review_reports", ["tenant_id"], unique=False
    )
...
def downgrade() -> None:
    ...
    op.drop_index(
        op.f("ix_discipline_subscriptions_user_id"), table_name="discipline_subscriptions"
    )
    op.drop_index(
        op.f("ix_discipline_subscriptions_tenant_id"), table_name="discipline_subscriptions"
    )
    op.drop_index(
        op.f("ix_discipline_subscriptions_discipline"), table_name="discipline_subscriptions"
    )
